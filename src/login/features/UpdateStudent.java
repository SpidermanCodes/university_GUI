...
public class UpdateStudent extends JPanel implements ActionListener {
    ...
    public UpdateStudent() {
        ...
        populateStudentDetails(labelname, labelfname, labeldob, labelx, labelxii, labelaadhar);
    ...
    private void populateStudentDetails(JLabel labelname, JLabel labelfname, JLabel labeldob, JLabel labelx, JLabel labelxii, JLabel labelaadhar) {
        try (Connection conn = DatabaseUtils.getConnection()) {
